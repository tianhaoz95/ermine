...
use burn::tensor::{DType, Shape, TensorData, FloatDType, IntDType, Distribution, Scalar, Slice};
use burn::tensor::ops::*;
...
impl<B: Backend> Backend for OffloadBackend<B> {
    ...
    fn dtype_usage(device: &Self::Device, dtype: DType) -> EnumSet<burn::tensor::backend::DTypeUsage> {
...
impl<B: Backend> FloatTensorOps<OffloadBackend<B>> for OffloadBackend<B> {
    ...
    fn float_into_data(tensor: B::FloatTensorPrimitive) -> impl Future<Output = Result<TensorData, ExecutionError>> + Send {
    ...
    fn float_to_device(tensor: B::FloatTensorPrimitive, device: &B::Device) -> B::FloatTensorPrimitive {
    ...
    fn float_slice_assign(tensor: B::FloatTensorPrimitive, ranges: &[Slice], value: B::FloatTensorPrimitive) -> B::FloatTensorPrimitive {
    ...
    fn float_equal(lhs: B::FloatTensorPrimitive, rhs: B::FloatTensorPrimitive) -> B::BoolTensorPrimitive {
    ...
    fn float_greater(lhs: B::FloatTensorPrimitive, rhs: B::FloatTensorPrimitive) -> B::BoolTensorPrimitive {
    ...
    fn float_greater_equal(lhs: B::FloatTensorPrimitive, rhs: B::FloatTensorPrimitive) -> B::BoolTensorPrimitive {
        B::float_greater_equal(lhs, rhs)
    }

    fn float_greater_equal_elem(lhs: B::FloatTensorPrimitive, rhs: Scalar) -> B::BoolTensorPrimitive {
        B::float_greater_equal_elem(lhs, rhs)
    }

    fn float_lower(lhs: B::FloatTensorPrimitive, rhs: B::FloatTensorPrimitive) -> B::BoolTensorPrimitive {
    ...
    fn float_lower_equal(lhs: B::FloatTensorPrimitive, rhs: B::FloatTensorPrimitive) -> B::BoolTensorPrimitive {
    ...
    fn float_sub(lhs: B::FloatTensorPrimitive, rhs: B::FloatTensorPrimitive) -> B::FloatTensorPrimitive {
        B::float_sub(lhs, rhs)
    }
    ...
    fn float_mul(lhs: B::FloatTensorPrimitive, rhs: B::FloatTensorPrimitive) -> B::FloatTensorPrimitive {
        B::float_mul(lhs, rhs)
    }
    ...
    fn float_div(lhs: B::FloatTensorPrimitive, rhs: B::FloatTensorPrimitive) -> B::FloatTensorPrimitive {
        B::float_div(lhs, rhs)
    }
    ...
    fn float_swap_dims(tensor: B::FloatTensorPrimitive, dim1: usize, dim2: usize) -> B::FloatTensorPrimitive {
        B::float_swap_dims(tensor, dim1, dim2)
    }

    fn float_random(shape: Shape, distribution: Distribution, device: &B::Device) -> B::FloatTensorPrimitive {
    ...
    fn float_powf_scalar(tensor: B::FloatTensorPrimitive, value: Scalar) -> B::FloatTensorPrimitive {
    ...
    fn float_max_dim_with_indices(tensor: B::FloatTensorPrimitive, dim: usize) -> (B::FloatTensorPrimitive, B::IntTensorPrimitive) {
    ...
    fn float_min_dim_with_indices(tensor: B::FloatTensorPrimitive, dim: usize) -> (B::FloatTensorPrimitive, B::IntTensorPrimitive) {
    ...
    fn float_mask_where(tensor: B::FloatTensorPrimitive, mask: B::BoolTensorPrimitive, value: B::FloatTensorPrimitive) -> B::FloatTensorPrimitive {
        B::float_mask_where(tensor, mask, value)
    }

    fn float_mask_fill(tensor: B::FloatTensorPrimitive, mask: B::BoolTensorPrimitive, value: Scalar) -> B::FloatTensorPrimitive {
        B::float_mask_fill(tensor, mask, value)
    }

    fn float_gather(dim: usize, tensor: B::FloatTensorPrimitive, indices: B::IntTensorPrimitive) -> B::FloatTensorPrimitive {
        B::float_gather(dim, tensor, indices)
    }

    fn float_scatter_add(dim: usize, tensor: B::FloatTensorPrimitive, indices: B::IntTensorPrimitive, value: B::FloatTensorPrimitive) -> B::FloatTensorPrimitive {
        B::float_scatter_add(dim, tensor, indices, value)
    }

    fn float_select(tensor: B::FloatTensorPrimitive, dim: usize, indices: B::IntTensorPrimitive) -> B::FloatTensorPrimitive {
        B::float_select(tensor, dim, indices)
    }

    fn float_clamp(tensor: B::FloatTensorPrimitive, min: Scalar, max: Scalar) -> B::FloatTensorPrimitive {
        B::float_clamp(tensor, min, max)
    }

    fn float_powf(lhs: B::FloatTensorPrimitive, rhs: B::FloatTensorPrimitive) -> B::FloatTensorPrimitive {
    ...
    fn float_unfold(tensor: B::FloatTensorPrimitive, dim: usize, size: usize, step: usize) -> B::FloatTensorPrimitive {
        B::float_unfold(tensor, dim, size, step)
    }

    fn float_remainder(_lhs: B::FloatTensorPrimitive, _rhs: B::FloatTensorPrimitive) -> B::FloatTensorPrimitive { todo!() }
    fn float_remainder_scalar(_lhs: B::FloatTensorPrimitive, _rhs: Scalar) -> B::FloatTensorPrimitive { todo!() }
    fn float_cross(_lhs: B::FloatTensorPrimitive, _rhs: B::FloatTensorPrimitive, _dim: usize) -> B::FloatTensorPrimitive { todo!() }
    fn float_select_add(_tensor: B::FloatTensorPrimitive, _dim: usize, _indices: B::IntTensorPrimitive, _value: B::FloatTensorPrimitive) -> B::FloatTensorPrimitive { todo!() }
    fn float_sum(_tensor: B::FloatTensorPrimitive) -> B::FloatTensorPrimitive { todo!() }
    fn float_sum_dim(_tensor: B::FloatTensorPrimitive, _dim: usize) -> B::FloatTensorPrimitive { todo!() }
    fn float_mean_dim(_tensor: B::FloatTensorPrimitive, _dim: usize) -> B::FloatTensorPrimitive { todo!() }
    fn float_cumsum(_tensor: B::FloatTensorPrimitive, _dim: usize) -> B::FloatTensorPrimitive { todo!() }
    fn float_cumprod(_tensor: B::FloatTensorPrimitive, _dim: usize) -> B::FloatTensorPrimitive { todo!() }
    fn float_cummin(_tensor: B::FloatTensorPrimitive, _dim: usize) -> B::FloatTensorPrimitive { todo!() }
    fn float_cummax(_tensor: B::FloatTensorPrimitive, _dim: usize) -> B::FloatTensorPrimitive { todo!() }
    fn float_cast(_tensor: B::FloatTensorPrimitive, _dtype: FloatDType) -> B::FloatTensorPrimitive { todo!() }
    fn float_powf_scalar_impl(_tensor: B::FloatTensorPrimitive, _value: Scalar) -> B::FloatTensorPrimitive { todo!() }
    fn float_tan(_tensor: B::FloatTensorPrimitive) -> B::FloatTensorPrimitive { todo!() }
    fn float_cosh(_tensor: B::FloatTensorPrimitive) -> B::FloatTensorPrimitive { todo!() }
    fn float_sinh(_tensor: B::FloatTensorPrimitive) -> B::FloatTensorPrimitive { todo!() }
    fn float_acos(_tensor: B::FloatTensorPrimitive) -> B::FloatTensorPrimitive { todo!() }
    fn float_acosh(_tensor: B::FloatTensorPrimitive) -> B::FloatTensorPrimitive { todo!() }
    fn float_asin(_tensor: B::FloatTensorPrimitive) -> B::FloatTensorPrimitive { todo!() }
    fn float_asinh(_tensor: B::FloatTensorPrimitive) -> B::FloatTensorPrimitive { todo!() }
    fn float_atan(_tensor: B::FloatTensorPrimitive) -> B::FloatTensorPrimitive { todo!() }
    fn float_atanh(_tensor: B::FloatTensorPrimitive) -> B::FloatTensorPrimitive { todo!() }
    fn float_atan2(_lhs: B::FloatTensorPrimitive, _rhs: B::FloatTensorPrimitive) -> B::FloatTensorPrimitive { todo!() }
    fn float_round(_tensor: B::FloatTensorPrimitive) -> B::FloatTensorPrimitive { todo!() }
    fn float_floor(_tensor: B::FloatTensorPrimitive) -> B::FloatTensorPrimitive { todo!() }
    fn float_ceil(_tensor: B::FloatTensorPrimitive) -> B::FloatTensorPrimitive { todo!() }
    fn float_trunc(_tensor: B::FloatTensorPrimitive) -> B::FloatTensorPrimitive { todo!() }
}
...
impl<B: Backend> IntTensorOps<OffloadBackend<B>> for OffloadBackend<B> {
    ...
    fn int_into_data(tensor: B::IntTensorPrimitive) -> impl Future<Output = Result<TensorData, ExecutionError>> + Send {
    ...
    fn int_slice_assign(tensor: B::IntTensorPrimitive, ranges: &[Slice], value: B::IntTensorPrimitive) -> B::IntTensorPrimitive {
    ...
    fn int_greater(lhs: B::IntTensorPrimitive, rhs: B::IntTensorPrimitive) -> B::BoolTensorPrimitive {
    ...
    fn int_greater_equal(lhs: B::IntTensorPrimitive, rhs: B::IntTensorPrimitive) -> B::BoolTensorPrimitive {
    ...
    fn int_lower_equal(lhs: B::IntTensorPrimitive, rhs: B::IntTensorPrimitive) -> B::BoolTensorPrimitive {
    ...
    fn int_random(shape: Shape, distribution: Distribution, device: &B::Device) -> B::IntTensorPrimitive {
    ...
    fn int_swap_dims(tensor: B::IntTensorPrimitive, dim1: usize, dim2: usize) -> B::IntTensorPrimitive {
    ...
    fn int_max_dim_with_indices(tensor: B::IntTensorPrimitive, dim: usize) -> (B::IntTensorPrimitive, B::IntTensorPrimitive) {
    ...
    fn int_min_dim_with_indices(tensor: B::IntTensorPrimitive, dim: usize) -> (B::IntTensorPrimitive, B::IntTensorPrimitive) {
    ...
    fn int_mask_where(tensor: B::IntTensorPrimitive, mask: B::BoolTensorPrimitive, value: B::IntTensorPrimitive) -> B::IntTensorPrimitive {
        B::int_mask_where(tensor, mask, value)
    }

    fn int_mask_fill(tensor: B::IntTensorPrimitive, mask: B::BoolTensorPrimitive, value: Scalar) -> B::IntTensorPrimitive {
        B::int_mask_fill(tensor, mask, value)
    }

    fn int_gather(dim: usize, tensor: B::IntTensorPrimitive, indices: B::IntTensorPrimitive) -> B::IntTensorPrimitive {
        B::int_gather(dim, tensor, indices)
    }

    fn int_scatter_add(dim: usize, tensor: B::IntTensorPrimitive, indices: B::IntTensorPrimitive, value: B::IntTensorPrimitive) -> B::IntTensorPrimitive {
        B::int_scatter_add(dim, tensor, indices, value)
    }

    fn int_select(tensor: B::IntTensorPrimitive, dim: usize, indices: B::IntTensorPrimitive) -> B::IntTensorPrimitive {
    ...
    fn int_unfold(tensor: B::IntTensorPrimitive, dim: usize, size: usize, step: usize) -> B::IntTensorPrimitive {
        B::int_unfold(tensor, dim, size, step)
    }

    fn bitwise_and(lhs: B::IntTensorPrimitive, rhs: B::IntTensorPrimitive) -> B::IntTensorPrimitive {
    ...
    fn bitwise_xor(lhs: B::IntTensorPrimitive, rhs: B::IntTensorPrimitive) -> B::IntTensorPrimitive {
    ...
    fn bitwise_left_shift(lhs: B::IntTensorPrimitive, rhs: B::IntTensorPrimitive) -> B::IntTensorPrimitive {
    ...
    fn bitwise_right_shift(lhs: B::IntTensorPrimitive, rhs: B::IntTensorPrimitive) -> B::IntTensorPrimitive {
        B::bitwise_right_shift(lhs, rhs)
    }

    fn bitwise_right_shift_scalar(lhs: B::IntTensorPrimitive, rhs: Scalar) -> B::IntTensorPrimitive {
        B::bitwise_right_shift_scalar(lhs, rhs)
    }

    fn int_remainder(lhs: B::IntTensorPrimitive, rhs: B::IntTensorPrimitive) -> B::IntTensorPrimitive {
    ...
    fn int_select_add(_tensor: B::IntTensorPrimitive, _dim: usize, _indices: B::IntTensorPrimitive, _value: B::IntTensorPrimitive) -> B::IntTensorPrimitive { todo!() }
    fn int_sum(_tensor: B::IntTensorPrimitive) -> B::IntTensorPrimitive { todo!() }
    fn int_sum_dim(_tensor: B::IntTensorPrimitive, _dim: usize) -> B::IntTensorPrimitive { todo!() }
    fn int_mean_dim(_tensor: B::IntTensorPrimitive, _dim: usize) -> B::IntTensorPrimitive { todo!() }
    fn int_cumsum(_tensor: B::IntTensorPrimitive, _dim: usize) -> B::IntTensorPrimitive { todo!() }
    fn int_cumprod(_tensor: B::IntTensorPrimitive, _dim: usize) -> B::IntTensorPrimitive { todo!() }
    fn int_cummin(_tensor: B::IntTensorPrimitive, _dim: usize) -> B::IntTensorPrimitive { todo!() }
    fn int_cummax(_tensor: B::IntTensorPrimitive, _dim: usize) -> B::IntTensorPrimitive { todo!() }
    fn int_cast(_tensor: B::IntTensorPrimitive, _dtype: IntDType) -> B::IntTensorPrimitive { todo!() }
    fn int_arange(_range: Range<i64>, _device: &B::Device) -> B::IntTensorPrimitive { todo!() }
    fn int_arange_step(_range: Range<i64>, _step: usize, _device: &B::Device) -> B::IntTensorPrimitive { todo!() }
    fn int_prod(_tensor: B::IntTensorPrimitive) -> B::IntTensorPrimitive { todo!() }
    fn int_prod_dim(_tensor: B::IntTensorPrimitive, _dim: usize) -> B::IntTensorPrimitive { todo!() }
}
...
impl<B: Backend> BoolTensorOps<OffloadBackend<B>> for OffloadBackend<B> {
    ...
    fn bool_into_data(tensor: B::BoolTensorPrimitive) -> impl Future<Output = Result<TensorData, ExecutionError>> + Send {
    ...
    fn bool_to_device(tensor: B::BoolTensorPrimitive, device: &B::Device) -> B::BoolTensorPrimitive {
    ...
    fn bool_slice_assign(tensor: B::BoolTensorPrimitive, ranges: &[Slice], value: B::BoolTensorPrimitive) -> B::BoolTensorPrimitive {
    ...
    fn bool_equal(lhs: B::BoolTensorPrimitive, rhs: B::BoolTensorPrimitive) -> B::BoolTensorPrimitive {
    ...
    fn bool_swap_dims(tensor: B::BoolTensorPrimitive, dim1: usize, dim2: usize) -> B::BoolTensorPrimitive {
    ...
    fn bool_select(tensor: B::BoolTensorPrimitive, dim: usize, indices: B::IntTensorPrimitive) -> B::BoolTensorPrimitive {
        B::bool_select(tensor, dim, indices)
    }

    fn bool_and(lhs: B::BoolTensorPrimitive, rhs: B::BoolTensorPrimitive) -> B::BoolTensorPrimitive {
        B::bool_and(lhs, rhs)
    }
    ...
    fn bool_xor(lhs: B::BoolTensorPrimitive, rhs: B::BoolTensorPrimitive) -> B::BoolTensorPrimitive {
        B::bool_xor(lhs, rhs)
    }
    ...
    fn bool_mask_where(tensor: B::BoolTensorPrimitive, mask: B::BoolTensorPrimitive, value: B::BoolTensorPrimitive) -> B::BoolTensorPrimitive {
        B::bool_mask_where(tensor, mask, value)
    }
    fn bool_mask_fill(tensor: B::BoolTensorPrimitive, mask: B::BoolTensorPrimitive, value: Scalar) -> B::BoolTensorPrimitive {
        B::bool_mask_fill(tensor, mask, value)
    }
    fn bool_gather(dim: usize, tensor: B::BoolTensorPrimitive, indices: B::IntTensorPrimitive) -> B::BoolTensorPrimitive {
        B::bool_gather(dim, tensor, indices)
    }
    fn bool_scatter_or(dim: usize, tensor: B::BoolTensorPrimitive, indices: B::IntTensorPrimitive, value: B::BoolTensorPrimitive) -> B::BoolTensorPrimitive {
    ...
    fn bool_unfold(tensor: B::BoolTensorPrimitive, dim: usize, size: usize, step: usize) -> B::BoolTensorPrimitive {
...
impl<B: Backend> ModuleOps<OffloadBackend<B>> for OffloadBackend<B> {
    ...
    fn max_pool1d_with_indices(x: FloatTensor<B>, kernel_size: usize, stride: usize, padding: usize, dilation: usize, ceil_mode: bool) -> MaxPool1dWithIndices<OffloadBackend<B>> {
        let b_res = B::max_pool1d_with_indices(x, kernel_size, stride, padding, dilation, ceil_mode);
    ...
    fn max_pool2d_with_indices(x: FloatTensor<B>, kernel_size: [usize; 2], stride: [usize; 2], padding: [usize; 2], dilation: [usize; 2], ceil_mode: bool) -> MaxPool2dWithIndices<OffloadBackend<B>> {
        let b_res = B::max_pool2d_with_indices(x, kernel_size, stride, padding, dilation, ceil_mode);
    ...
    fn deform_conv2d(_: FloatTensor<B>, _: FloatTensor<B>, _: FloatTensor<B>, _: Option<FloatTensor<B>>, _: Option<FloatTensor<B>>, _: DeformConvOptions<2>) -> FloatTensor<B> { todo!() }
    fn deform_conv2d_backward(_: FloatTensor<B>, _: FloatTensor<B>, _: FloatTensor<B>, _: Option<FloatTensor<B>>, _: Option<FloatTensor<B>>, _: FloatTensor<B>, _: DeformConvOptions<2>) -> DeformConv2dBackward<OffloadBackend<B>> { todo!() }
    fn conv3d(_: FloatTensor<B>, _: FloatTensor<B>, _: Option<FloatTensor<B>>, _: ConvOptions<3>) -> FloatTensor<B> { todo!() }
    fn conv_transpose3d(_: FloatTensor<B>, _: FloatTensor<B>, _: Option<FloatTensor<B>>, _: ConvTransposeOptions<3>) -> FloatTensor<B> { todo!() }
    fn avg_pool2d_backward(_: FloatTensor<B>, _: FloatTensor<B>, _: [usize; 2], _: [usize; 2], _: [usize; 2], _: bool, _: bool) -> FloatTensor<B> { todo!() }
    fn adaptive_avg_pool2d_backward(_: FloatTensor<B>, _: FloatTensor<B>) -> FloatTensor<B> { todo!() }
    fn max_pool2d_with_indices_backward(_: FloatTensor<B>, _: [usize; 2], _: [usize; 2], _: [usize; 2], _: [usize; 2], _: bool, _: FloatTensor<B>, _: IntTensor<B>) -> MaxPool2dBackward<OffloadBackend<B>> { todo!() }
    fn interpolate_backward(_: FloatTensor<B>, _: FloatTensor<B>, _: [usize; 2], _: InterpolateOptions) -> FloatTensor<B> { todo!() }
}
...
impl<B: Backend> QTensorOps<OffloadBackend<B>> for OffloadBackend<B> {
    ...
    fn q_into_data(tensor: B::QuantizedTensorPrimitive) -> impl Future<Output = Result<TensorData, ExecutionError>> + Send {
        B::q_into_data(tensor)
    }
    fn quantize(tensor: B::FloatTensorPrimitive, scheme: &burn::tensor::quantization::QuantScheme, parameters: burn::tensor::quantization::QuantizationParametersPrimitive<OffloadBackend<B>>) -> B::QuantizedTensorPrimitive {
    ...
    fn q_to_device(tensor: B::QuantizedTensorPrimitive, device: &B::Device) -> B::QuantizedTensorPrimitive {
    ...
    fn q_swap_dims(tensor: B::QuantizedTensorPrimitive, dim1: usize, dim2: usize) -> B::QuantizedTensorPrimitive {
        B::q_swap_dims(tensor, dim1, dim2)
    }
    fn q_permute(tensor: B::QuantizedTensorPrimitive, dims: &[usize]) -> B::QuantizedTensorPrimitive {
    ...
    fn q_select(tensor: B::QuantizedTensorPrimitive, dim: usize, indices: B::IntTensorPrimitive) -> B::QuantizedTensorPrimitive {
        B::q_select(tensor, dim, indices)
    }
    fn q_slice(tensor: B::QuantizedTensorPrimitive, ranges: &[Slice]) -> B::QuantizedTensorPrimitive {
...
pub(crate) fn offload_prefetch_hook<B: Backend>(primitive: crate::ops::PrefetchTensorPrimitive<B>, device: &B::Device) {
