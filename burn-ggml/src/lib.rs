...
mod tests {
    ...
    async fn test_add() {
        ...
        data.assert_approx_eq(&TensorData::from([[6.0, 8.0], [10.0, 12.0]]), Tolerance::<f32>::absolute(1e-5));
    }
    ...
    async fn test_mul() {
        ...
        data.assert_approx_eq(&TensorData::from([[5.0, 12.0], [21.0, 32.0]]), Tolerance::<f32>::absolute(1e-5));
    }
    ...
    async fn test_matmul() {
        ...
        data.assert_approx_eq(&TensorData::from([[19.0, 22.0], [43.0, 50.0]]), Tolerance::<f32>::absolute(1e-5));
    }
}
